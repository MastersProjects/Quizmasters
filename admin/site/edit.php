...
/* --- SQL Query Start --- */
$username_friend = $_GET ['user'];

$qy_user = "SELECT * FROM user WHERE ID_Benutzername =  '$username_friend';";
...
<p class="titel"><?php echo $username_friend?>'s Profil:</p>
<div id="mid">

	<form class="formular" action="site/active.php" method="post">
		<table>
			<tr>
				<!-- Verborgenes Feld für den Username - Liest den Username aus dem Formular aus -->
				<td><input type="hidden" name="origname" id="username"
					value="<?php echo $username_friend?>"></td>
			</tr>
			<tr>
				<!-- Verborgenes Feld für den Username - Liest den Username aus dem Formular aus -->
				<td>Username:</td>
			...
			<tr>
				<!-- Feld für Punkte - aenderbar -->
				<td>Punkte:</td>
				<td><input type="text" name="punkte" id="username"
					value="<?php echo $punkte?>" autocomplete="on" maxlength="254"
					required></td>
			</tr>
			<tr>
				<!-- Feld für Rang - aenderbar -->
				<td>Rang:</td>
				<td><input type="text" name="rang" id="username"
					value="<?php echo $rang?>" autocomplete="on" maxlength="254"
					required></td>
			</tr>
			<tr>
				<!-- Feld für Cheat - aenderbar -->
				<td>Cheat:</td>
				<td><input type="text" name="cheat" id="username"
					value="<?php echo $cheat?>" autocomplete="on" maxlength="254"
					required></td>
			</tr>
			<tr>
		...
		<p class="break"></p>
		<input type="submit" id="button" value="Speichern"><input
			id="button_long" type="button" value="Passwort &auml;ndern"
			onclick="location='?site=pwedit'"> <input type="button"
			value="Abbrechen" id="button" onclick="location='?site=profile'">
	</form>
	<div id="delete">
		<h3>
			Profil l&ouml;schen! (JA eingeben)
			<form class="loeschen" action="site/delete.php" method="post">

				<input type="hidden" name="originalname" id="button"
					value="<?php echo $username_friend?>" readonly="readonly"> <input
					type="text" name="delete" value="" placeholder="JA"> <input
					type="submit" id="button" value="L&ouml;schen">
			</form>
		</h3>
	</div>
</div>
