...
<head>
<meta charset="utf-8">
<title>Quizmasters | Error 406 - Not Acceptable</title>
...
<div id="navigation">
	...
	<div id="content">
		<p class="titel">ERROR 406 Not Acceptable</p>
		<div class="left">
		<img src="../img/diverses/policeman.png" class="text" alt="bild" />
		</div>
		<div class="right">
		<h3 class="red_color">STOPP!</h3>
		<h3>Hier geht es nicht mehr weiter! <br />
		Ihre Eingabe ist nicht zul&auml;ssig!</h3>
